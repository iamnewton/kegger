...
* Go to the issue tracker and [filter open issues by the `support` label](https://github.com/iamnewton/kegger/issues?q=is%3Aopen+is%3Aissue+label%3Asupport).
...
* Leave a message when closing saying "Cleaning up stale issue. Please reopen or ping us if and when you're ready to resume this. See https://github.com/iamnewton/kegger/blob/latest/MAINTAINING.md#clean-up-issues-and-prs for more details."
...
1. Clone the repo (`git clone https://github.com/iamnewton/kegger`)
